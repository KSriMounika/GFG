<h2><a href="https://www.geeksforgeeks.org/problems/fill-linkedlist/1?page=3&category=Java-Collections&sortBy=submissions">Fill LinkedList</a></h2><h3>Difficulty Level : Difficulty: Basic</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">You are given an integer LinkedList <strong>ll</strong>, you are also given a value <strong>k</strong>. You need to fill arr with k.</span></p>
